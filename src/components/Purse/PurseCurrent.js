...
import { FilterContext } from "./PurseBlock";
import "./PurseCurrent.css";

const PurseCurrent = (props) => {
  ...
  return (
    <div className="purse__current">
      <div className="purse__current-title">
        <h1 className="fs-normal fw-light">{twoDigitYear}년 자산 현황</h1>
        <strong className="fs-title">
          {addComma(totalBalance.toString())}원
        </strong>
      </div>
      <div className="purse__current-detail">
        <div className="purse__current-detail--desc">
